...
## "suggested" only will fail due to dependencies, simply get all advised plugins
...
echo "Installation is complete, now use jenkins-first-launch.sh to start Jenkins"
